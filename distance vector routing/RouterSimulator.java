...
/* ******************************************************************
Assignment 4: implementing distributed, asynchronous, distance vector routing.
...
THERE IS NOT REASON THAT ANY STUDENT SHOULD HAVE TO READ OR UNDERSTAND THE CODE BELOW.
YOU SHOLD NOT TOUCH, OR REFERENCE (in your code) ANY OF THE DATA STRUCTURES BELOW.
If you're interested in how the emulator is designed, you're welcome to look at the code.
But again, you should not have to, and you defeinitely should not have to modify this code.
******************************************************************/
